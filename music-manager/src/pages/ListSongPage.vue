...
import {songOfSongListId ,songOfSongId,songOfSongName,listSongAdd,delListSong} from '../api/index';
...
export default {
    ...
    methods:{
        ...
        getData(){
            this.tempData = [];
            this.tableData = [];
            songOfSongListId(this.songListId).then(res => {
                  this.tempData = res;
                  this.tableData = res;
                  this.currentPage = 1;
            })
